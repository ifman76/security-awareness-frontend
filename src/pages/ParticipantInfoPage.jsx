...
export default function ParticipantInfoPage() {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">참여자 정보 입력 / Participant Information</h1>

      {/* 연령대 */}
      <div className="mb-4">
        <label className="block mb-1 font-medium">연령대 / Age Group</label>
        <select
          value={ageGroup}
      ...
      {/* 성별 */}
      <div className="mb-4">
        <label className="block mb-1 font-medium">성별 / Gender</label>
        <select
          value={gender}
      ...
      {/* 직업군 */}
      <div className="mb-4">
        <label className="block mb-1 font-medium">직업군 / Occupation</label>
        <select
          value={occupation}
      ...
      {/* AI 사용 경험 */}
      <div className="mb-4">
        <label className="block mb-1 font-medium">생성형 AI 사용 경험 / Experience with Generative AI</label>
      ...
      {/* 자기평가 */}
      <div className="mb-6">
        <label className="block mb-1 font-medium">본인의 보안 인식 수준 (1~5점 자기평가) / Your own security awareness level (self-rated 1~5)</label>
