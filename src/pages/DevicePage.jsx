  ...
  return (
    <div className="p-6">
      {!surveyDone ? (
        ...
        <div className="mt-10">
          <h2 className="text-xl font-semibold mb-4">보유 기기 선택 / Owned Device Selection</h2>
          <p className="text-sm text-gray-600 mb-6">
            소유하고 있는 기기를 선택해 주세요. 이 정보는 보안인식 수준 평가에 반영되며, 원치 않을 경우 '선택하지 않음' 버튼을 선택하실 수 있습니다. 원하지 않으시면 &quot;선택하지 않음&quot;을 눌러주세요.
          </p>
          <p className="text-sm text-gray-600 mb-6">
          ...
          <div className="mb-2">
            <label className="block mb-1">카테고리 / Category:</label>
          ...
          {selectedCategory && (
            <div className="mb-2">
              <label className="block mb-1">메이커 / Maker:</label>
          ...
          {selectedMaker && (
            <div className="mb-2">
              <label className="block mb-1">제품 / Product :</label>
          ...
          }} className="px-4 py-2 bg-green-600 text-white rounded-lg mt-2">기기 추가 / Add</button>

          {ownedDevices.length > 0 && (
            <div className="mt-4">
              <h3 className="font-semibold mb-2">선택한 기기 / Selected Device :</h3>
